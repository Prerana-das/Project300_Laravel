...
<html lang="en">
	...
	<body>
		...
		<header id="mainNav"> 
			<div class="container">
				<div class="row">
					<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 mx-auto text-center">
						...
						<div class="main-menu">
							...
							<a href="#" class="toggle-menu">&#9776;</a>
								<ul class="nav-list nav-open" id="nav">
									...
									<li class="nav-item"><a class="js-scroll-trigger" href="about.html">Tour</a></li>
									<li class="nav-item"><a class="js-scroll-trigger" href="service.html">Destination</a></li>
									<li class="nav-item"><a class="js-scroll-trigger" href="team.html">
									<img src="images/travello.png" alt="travello" /></a></li>
									<li class="nav-item"><a class="js-scroll-trigger" href="work.html">Pages</a></li>
									<li class="nav-item"><a class="js-scroll-trigger" href="work.html">Blog</a></li>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="tour-menu">
							<ul>
								<li><a href=""><i class="fas fa-file-alt"></i>INFORMATION</a></li>
								<li><a href=""><i class="fas fa-clipboard-list"></i>TOUR PLAN</a></li>
